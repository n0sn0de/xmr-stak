...
// cryptonight_gpu memory and iteration constants
...
{
	if(algo_id == cryptonight_gpu)
		return xmrstak_algo(cryptonight_gpu, cryptonight_gpu, CN_GPU_ITER, CN_MEMORY, CN_GPU_MASK);
	else
		return xmrstak_algo(invalid_algo, invalid_algo);
}
